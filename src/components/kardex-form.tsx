// src/components/kardex-form.tsx
"use client";
...
// Importamos el nuevo tipo de dato
import type { ProductForReport } from "@/app/(protected)/reports/predetermined/actions";
import {
    Card,
    CardContent,
    CardDescription,
                                    ...
                                    <Popover>
                                        ...
                                        <PopoverContent className="w-auto p-0" align="start">
                                            <Calendar
                                                ...
                                                onSelect={(range) => {
                                                    if(range?.from && range?.to) { // Asegurarse que el rango esté completo
