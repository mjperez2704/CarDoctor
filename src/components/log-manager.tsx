// src/components/log-manager.tsx
"use client";
...
import type { LogEntry } from "@/app/(protected)/internal/log/actions";
...
export function LogManager({ initialLogs, users }: LogManagerProps) {
    ...
    // Ya no se necesita `getUserName`, el nombre viene en la consulta
